  ...
  describe('validateFlow', () => {
    it('should validate workflow with start and end nodes', () => {
      const nodes: WorkflowNode[] = [
        ...
        { id: 'end', type: NodeType.END, position: { x: 100, y: 0 }, data: { type: NodeType.END, label: 'End' } },
      ];
    ...
    it('should report error for missing start node', () => {
      const nodes: WorkflowNode[] = [
        { id: 'agent', type: NodeType.AGENT, position: { x: 0, y: 0 }, data: { type: NodeType.AGENT, label: 'Agent' } },
      ];
      const edges: WorkflowEdge[] = [];
    ...
    it('should detect cycles', () => {
      const nodes: WorkflowNode[] = [
        { id: 'a', type: NodeType.AGENT, position: { x: 0, y: 0 }, data: { type: NodeType.AGENT, label: 'A' } },
        { id: 'b', type: NodeType.AGENT, position: { x: 100, y: 0 }, data: { type: NodeType.AGENT, label: 'B' } },
      ];
      const edges: WorkflowEdge[] = [
